...
@dso_cache = dso_local local_unnamed_addr global [504 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1176409509817726158, ; hash 0x105372375f13b4ce, from name: aot-TableTopWarGameSimulator
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TableTopWarGameSimulator.dll.so
		ptr null; void* handle (0x0)
	}, ; 29
	%struct.DSOCacheEntry {
		i64 1196280833168408863, ; hash 0x109a0b14609c811f, from name: libaot-System.Diagnostics.TraceSource
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.58_name, ; name: libaot-System.Diagnostics.TraceSource.dll.so
		ptr null; void* handle (0x0)
	}, ; 30
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Maui.DataGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 39
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.78_name, ; name: libaot-System.Threading.ThreadPool.dll.so
		ptr null; void* handle (0x0)
	}, ; 112
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6391824979637553213, ; hash 0x58b452f421c3c83d, from name: TableTopWarGameSimulator.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TableTopWarGameSimulator.dll.so
		ptr null; void* handle (0x0)
	}, ; 153
	...
	%struct.DSOCacheEntry {
		i64 6468276347982211888, ; hash 0x59c3ef116e8a6b30, from name: TableTopWarGameSimulator
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TableTopWarGameSimulator.dll.so
		ptr null; void* handle (0x0)
	}, ; 155
	...
	%struct.DSOCacheEntry {
		i64 10991024081687590778, ; hash 0x9887f62b5ac0b77a, from name: libaot-TableTopWarGameSimulator
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TableTopWarGameSimulator.dll.so
		ptr null; void* handle (0x0)
	}, ; 291
	...
	%struct.DSOCacheEntry {
		i64 17768176172402682961, ; hash 0xf6953e16c69f2c51, from name: libaot-TableTopWarGameSimulator.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TableTopWarGameSimulator.dll.so
		ptr null; void* handle (0x0)
	}, ; 480
	...
	%struct.DSOCacheEntry {
		i64 18317383419734944099, ; hash 0xfe346b2babee6963, from name: aot-TableTopWarGameSimulator.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TableTopWarGameSimulator.dll.so
		ptr null; void* handle (0x0)
	}, ; 499
...
@.env.3 = private unnamed_addr constant [37 x i8] c"528882a2-e17d-432b-a4cc-d143d3c13848\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [41 x i8] c"com.companyname.tabletopwargamesimulator\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [39 x i8] c"libaot-TableTopWarGameSimulator.dll.so\00", align 16
@.DSOCacheEntry.8_name = private unnamed_addr constant [28 x i8] c"libaot-Maui.DataGrid.dll.so\00", align 16
...
@.DSOCacheEntry.58_name = private unnamed_addr constant [45 x i8] c"libaot-System.Diagnostics.TraceSource.dll.so\00", align 16
...
@.DSOCacheEntry.78_name = private unnamed_addr constant [42 x i8] c"libaot-System.Threading.ThreadPool.dll.so\00", align 16
